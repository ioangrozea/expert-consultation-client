...
export const getDocuments = createSelector(
  ...
  (entities: { [id: number]: DocumentConsolidate }) =>
...
export const getDocumentsPageData = createSelector(
  getDocumentsState,
  fromDocuments.getDocumentsPageData
);
